...
const TemplatesHomePage = () => { // Renamed from IndexPage
  useEffect(() => {
    setupLoad();
    setupScroll();
    setupBeforeUnload();
    track("Visited Templates Home"); // Modified tracking event
  }, []);
  ...
  return (
    <>
      <Head>
        <meta
          name="description"
          content="Regain control of your life with ADHD. Discover the first suite of scientifically designed ADHD life management tools. (Moved from original homepage)"
        />
        <title>Templates Home</title> {/* Added a title */}
      </Head>
      <div>
        <HPHeader />
        <HPHeroSection />
...
export default TemplatesHomePage; // Renamed from IndexPage 