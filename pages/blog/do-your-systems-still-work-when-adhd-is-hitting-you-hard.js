...
const SystemsFailBlog = () => {
  return (
    <BlogArticle
      title="ADHD Shutdown: When Your Systems Stop Working Too"
      description="Most ADHD systems fail exactly when you need them most. What support that survives an ADHD shutdown or a genuinely bad day actually looks like."
      ...
      heading="ADHD Shutdown: Do Your Systems Still Work on Your Worst Days?"
