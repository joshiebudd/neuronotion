...
const ADHDRoutinesBlog = () => {
  return (
    <BlogArticle
      ...
      heroImage="https://files.manuscdn.com/user_upload_by_module/session_file/310519663094569463/GPvWuqqMlJXqGfva.jpeg"
    >
      <div className="blog-content">
        ...
        <br />
        <br />
        <h2 className="blog-subheader">How Romi Makes Routines Sustainable</h2>
        <p className="blog-body">
        ...
        <br />
        <p className="blog-body">
          This is where <strong>Romi</strong> transforms routine-building from aspirational to achievable:
        </p>
        <br />
        <br />
        <ul className="list-disc ml-8 blog-body space-y-3">
        ...
        <br />
        <p className="blog-body">
          <strong>Romi</strong> excels at this micro-habit approach by breaking down any routine into its smallest possible components and helping you build them one at a time. It provides the scaffolding that prevents the routine from collapsing while you&apos;re still in the building phase.
        </p>
        <br />
        <br />
        <p className="blog-body">
        ...
        <br />
        <p className="blog-body">
          <strong>Romi</strong> provides exactly this kind of support. It doesn&apos;t try to fix your ADHD or make you more like neurotypical people. It simply makes sustainable routines possible by accommodating the very traits that make traditional habit-building impossible for you.
        </p>
        <br />
        <br />
        <p className="blog-body">
