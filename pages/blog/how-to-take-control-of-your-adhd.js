...
const TakeControlADHDBlog = () => {
  return (
    <BlogArticle
      title="How to Take Control of Your ADHD Instead of Letting It Control You | Romi"
      description="Stop letting ADHD control you. Learn 5 proven strategies to work WITH your ADHD brain: quarterly goals, dopamine hacking, and accountability systems that actually stick."
      ...
      heroImage="https://files.manuscdn.com/user_upload_by_module/session_file/310519663094569463/aHPlhULEzomtJJSq.jpeg"
    >
      <div className="blog-content">
              ...
              <ul className="list-disc ml-8 blog-body">
                ...
                <li>Use tools like <strong>Romi</strong> that provide consistent external structure</li>
              ...
              <br />
              <br />
              <h2 className="blog-subheader">How Romi Helps You Take Control</h2>
              <p className="blog-body">
              ...
              <br />
              <p className="blog-body">
                This is where <strong>Romi</strong> becomes your external accountability system:
              </p>
              <br />
              <br />
              <ul className="list-disc ml-8 blog-body">
