  ...
  return (
    ...
    >
      <div className="blog-content">
              ...
              <br />
              <p className="blog-body">
                Typical productivity advice like bullet journals, time blocking, the Pomodoro Technique and Getting Things Done (GTD) all require significant executive function to implement and maintain. They&apos;re tools for people who already have the very skills that ADHD makes difficult. It&apos;s like handing someone with a broken leg a pair of running shoes and telling them to &quot;just start jogging.&quot;
              </p>
              <br />
              <br />
              <p className="blog-body">
