...
const Timer = () => {
  ...
  const handlePlayClick = () => {
    ...
    const selectedTime = parseInt(currentDuration === undefined ? timerSelect.value : currentDuration);
  ...
  const handleAudioSelectChange = (event) => {
    ...
    switch (selectedAudio) {
      case 'binauralbeats':
        audioSource = 'https://NeuroNotionPullZonw.b-cdn.net/90min_Binaural_Beats.mp3';
        break;
      case 'whitenoise':
        audioSource = 'https://neuronotionpullzonw.b-cdn.net/onlymp3.to_-_ADHD_ADD_Relief_WHITE_NOISE_Natural_Sound_For_Better_Focus_And_Sleep_Proven_by_Science_-NWlFKrzvsm0-192k-1701018887.mp3';
        break;
      case 'brownnoise':
        audioSource = 'https://NeuroNotionPullZonw.b-cdn.net/onlymp3.to_-_brown_noise_for_studying_with_alpha_beta_wave_isochronic_tones-1ZxJfdghjs4-192k-1701018882.mp3';
        break;
      case 'lofibeats':
        audioSource = 'https://NeuroNotionPullZonw.b-cdn.net/onlymp3.to%20-%20Best%20of%20lofi%20hip%20hop%202023%20beats%20to%20relax%20study%20to-mmKguZohAck-192k-1709122744.mp3';
        break;
      default:
        audioSource = '';
    }
  ...
  return (
    <div className="transition duration-150 h-screen flex items-center justify-center" style={{ backgroundColor: isDarkMode ? '#191919' : '#ffffff' }}>
      <div className="text-center px-4 overflow-hidden">
        <div className="flex flex-row justify-center flex-wrap md:flex-nowrap items-center space-y-0 md:space-x-5">
          <div className="flex flex-row md:flex-col order-2 md:order-1">
            <div id="playdiv" onClick={handlePlayClick} className="cursor-pointer">
              <img
                id="img_play"
                className="w-10 h-10"
                src={isDarkMode ? 'https://raw.githubusercontent.com/joshiebudd/neuronotion/main/assets/dark_play.png' : 'https://raw.githubusercontent.com/joshiebudd/neuronotion/main/assets/play.png'}
                alt="Play"
              />
            </div>
            <div id="themeToggle" onClick={toggleTheme} className="cursor-pointer">
              <img
                id="img_themeToggle"
                className="w-10 h-10"
                src={isDarkMode ? 'https://raw.githubusercontent.com/joshiebudd/neuronotion/main/assets/lmtoggle.png' : 'https://raw.githubusercontent.com/joshiebudd/neuronotion/main/assets/lmdm.png'}
                alt="Toggle Theme"
              />
            </div>
          </div>
          <div
            id="countdown"
            className={`text-4xl md:text-6xl italic min-w-full md:min-w-0 font-bold order-1 md:order-2 focus:outline-none ${isDarkMode ? 'text-gray-50' : ''}`}
  ...
  <div id="pausediv" onClick={handlePauseClick} className={`cursor-pointer ${countdownInterval ? '' : 'pointer-events-none opacity-50'}`}>
    <img
      id="img_pause"
      className="w-10 h-10"
      src={isDarkMode ? 'https://raw.githubusercontent.com/joshiebudd/neuronotion/main/assets/dark_pause.png' : 'https://raw.githubusercontent.com/joshiebudd/neuronotion/main/assets/pause.png'}
      alt="Pause"
    />
  </div>
  <div id="resetdiv" onClick={handleResetClick} className="cursor-pointer">
    <img
      id="img_reset"
      className="w-10 h-10"
      src={isDarkMode ? 'https://raw.githubusercontent.com/joshiebudd/neuronotion/main/assets/dark_reset.png' : 'https://raw.githubusercontent.com/joshiebudd/neuronotion/main/assets/reset.png'}
      alt="Reset"
    />
  </div>
</div>
...
<div className="text-xs flex relative inline-block pt-3 pb-3">
  ...
  >
    <option value="0">Please select the length of your study lesson</option>
  ...
  <div className="pointer-events-none absolute inset-y-0 right-0 flex items-center px-2 text-gray-700">
    <svg className="fill-current h-4 w-4 mt-3 mb-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
...
<div className="text-xs flex flex-wrap md:flex-nowrap items-center justify-center">
  ...
  <div className="flex flex-col">
    <div id="playAudiodiv" onClick={handlePlayAudioClick} className="cursor-pointer">
      <img
        id="audio_play"
        className="w-10 h-10"
        src={isDarkMode ? 'https://raw.githubusercontent.com/joshiebudd/neuronotion/main/assets/dark_play.png' : 'https://raw.githubusercontent.com/joshiebudd/neuronotion/main/assets/play.png'}
  ...
  <div className="flex flex-col">
    <div id="stopAudiodiv" onClick={handleStopAudioClick} className="cursor-pointer">
      <img
        id="audio_stop"
        className="w-10 h-10"
        src={isDarkMode ? 'https://raw.githubusercontent.com/joshiebudd/neuronotion/main/assets/dark_pause.png' : 'https://raw.githubusercontent.com/joshiebudd/neuronotion/main/assets/pause.png'}
...
<audio ref={bellSoundRef} src="https://NeuroNotionPullZonw.b-cdn.net/bell%20(1).mp3" />
</div>
);
};
