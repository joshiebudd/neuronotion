    ...
    return (
        <section className="fixed bottom-0 w-full z-10 bg-prim bg-opacity-75 p-4">
            <div className="max-w-5xl mx-auto flex items-center justify-between gap-2">
                ...
                <button onClick={handleDismiss} className="flex items-center justify-center text-gray-700 transition-colors duration-300 rounded-full dark:text-gray-200 dark:hover:bg-gray-700 w-7 h-7 focus:outline-none hover:bg-gray-200">
