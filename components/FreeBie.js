          ...
          <div className="md:relative md:block order-3 md:left-[40%] md:top-[100px] md:w-1/2 ">
            <div className="flex justify-center">
              <button
                ...
                class="flex md:w-80 w-72 justify-center rounded-md bg-blue-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
              >
                Get Freebie
              </button>
            </div>
            <div className="pt-3 ">
              <p className=" italic text-xl leading-10 text-gray-700">
                No Email Required
              </p>
            </div>
          </div>
