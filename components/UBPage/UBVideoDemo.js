...
const UBClarity = () => {
  return (
    <div className="lg:px-0 px-8 pt-10 mt-16 bg-white text-center">
      ...
      <div className="bg-gray-200 rounded-3xl flex items-center justify-center lg:mx-60 aspect-video my-8">
        <video
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="flex-grow flex items-center justify-center">
                <span className="text-gray-700 font-cg font-normal">
                  This template is an unbelievable <b>all-in-one system</b> with incredible automation. Its perfect for use <b>out of the box</b> with super clear instructions at every page. <b>I would highly recommend it to anyone with ADHD.</b>
                </span>
              </div>
            </div>
            <div className="mt-4">
