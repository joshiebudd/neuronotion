...
const HPFAQSection = () => {
  ...
  return (
    <section id="faqs" className="bg-white py-12 sm:py-16 FAQ_section">
      <div className="text-center">
      <div className="inline-block px-3 py-1 mb-6 bg-gray-300 rounded-full text-xs text-grey-950 font-baloo font-semibold">
            FAQs
            </div>
