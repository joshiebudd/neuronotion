    ...
    <header className="bg-white bg-opacity-30 backdrop-blur-lg z-10 fixed top-0 right-0 left-0 shadow">
      <div className="container mx-auto flex justify-between items-center py-4 px-6">
        ...
        >
          ...
          />
          <div className="w-full grow text-center md:text-left">
        ...
        <nav className="hidden md:flex space-x-4 items-center">
          <a href="https://claudia-theta.vercel.app/" className="text-prim hover:text-gray-900 text-lg md:xl font-pop font-bold">Claudia</a>
