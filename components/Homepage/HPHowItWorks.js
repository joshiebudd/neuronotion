  ...
  return (
    <section className="text-center pb-20 md:pb-40 bg-opacity-10">
      <div className="relative shadow-xl px-4 md:px-8 py-8 md:py-16 bg-accent2 bg-opacity-10 rounded-3xl max-w-5xl mx-4 md:mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center space-y-4 md:space-y-0 md:space-x-12 mb-4 md:mb-12">
          ...
          <div className="flex items-center transform rotate-90 md:rotate-0 mx-1 md:mx-2">
