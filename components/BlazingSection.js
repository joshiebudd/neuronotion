    ...
    <section id="benefits" className="bg-white benefits-section">
      <div className="py-8 sm:py-24 px-4 mx-auto max-w-screen-xl lg:px-24">
        ...
        <div className="gap-x-2 lg:gap-y-2 flex items-center mt-8 flex-wrap md:flex-nowrap">
          {/* begin placeholder */}
          <div className="flex items-center text-center justify-center mb-2 ml-0 mt-2 mx-12 order-2 w-full min-w-[200px] md:w-fit">
            <Image
          ...
          {/* begin - description */}
          <div className="max-w-[600px] flex flex-col ml-12 sm:items-center justify-center mb-12 order-1 md:mb-0 lg:mx-4 w-full">
            <div>
