    ...
    <nav className="px-8 py-5 lg:px-6">
        <div className="mx-auto flex max-w-screen-xl flex-wrap items-center justify-between">
            ...
            <div className="hidden lg:flex items-center space-x-4">
                <a onClick={() => scrollToMiddle('features')} className="px-2 py-1 text-base font-thin text-black hover:text-gray-600 cursor-pointer hover:underline">Features</a>
                <a onClick={() => scrollToMiddle('pricing')} className="px-2 py-1 text-base font-thin text-black hover:text-gray-600 cursor-pointer hover:underline">Pricing</a>
                <a onClick={() => scrollToMiddle('faqs')} className="px-2 py-1 text-base font-thin text-black hover:text-gray-600 cursor-pointer hover:underline">FAQs</a>
            </div>
            <div className="flex-grow"></div> {/* Added flex-grow to push the button to the right */}
            <a href="#pricing" onClick={handleButtonClick} className="inline-block rounded-lg bg-black px-4 py-2 text-base font-bold text-white hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 lg:px-8 lg:py-4">Buy Now</a>
        </div>
    </nav>
</div>
